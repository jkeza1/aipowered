<?php
$result = mysqli_query($conn, "SELECT * FROM passportinfo WHERE status='Active' LIMIT 1");
...
<div class="container">
    ...
    <div class="p-4">
        ...
        <p><strong>Fee:</strong>
            <?php echo htmlspecialchars($row['fee']); ?>
        </p>
...
<?php
include 'applicationpassportreplacementmodal.php';
?>