<?php
$result = mysqli_query($conn, "SELECT * FROM criminalrecordinfo WHERE status='Active' LIMIT 1");
...
<?php else: ?>
    ...
    <div class="alert alert-warning text-center">
        No active Criminal Record service found.
    </div>
...
<?php
include 'applicationcriminalrecordmodal.php';
?>