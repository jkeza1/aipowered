<?php
$result = mysqli_query($conn, "SELECT * FROM provisionaldrivinginfo WHERE id=1 LIMIT 1");
$row = mysqli_fetch_assoc($result);
?>

<section class="ftco-section services-section">
<div class="container">
    <h3 class="mb-4 text-center"><?php echo __('admin_setting_provisional_driving'); ?></h3>
...
<?php echo $row['requirements'] ?? ''; ?>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" name="processing_time" class="form-control"
                       ...
                       placeholder="<?php echo __('admin_example_1_day'); ?>">
            </div>
    ...
    <button type="submit" name="saveprovisional" class="btn btn-primary btn-block mt-3">
