<?php
$result = mysqli_query($conn, "SELECT * FROM marriageinfo WHERE id=1 LIMIT 1");
$row = mysqli_fetch_assoc($result);
?>

<section class="ftco-section services-section">
<div class="container">
    <h3 class="mb-4 text-center"><?php echo __('admin_setting_marriage_certificate'); ?></h3>
...
<?php echo $row['requirements'] ?? ''; ?>
    ...
    <button type="submit" name="savemarriage" class="btn btn-primary btn-block mt-3">
