<?php
$result = mysqli_query($conn, "SELECT * FROM drivinglicenseinfo ORDER BY ID ASC LIMIT 1");
$row = mysqli_fetch_assoc($result);
?>

<section class="ftco-section services-section">
<div class="container">
    <h3 class="mb-4 text-center"><?php echo __('admin_setting_definitive_driving'); ?></h3>
...
<?php echo $row['requirements'] ?? ''; ?>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" name="processing_time" class="form-control"
                       ...
                       placeholder="<?php echo __('admin_example_14_days'); ?>">
            </div>
            ...
            <div class="form-group">
                <label><?php echo __('admin_currency'); ?></label>
    ...
    <button type="submit" name="savedrivinglicense" class="btn btn-primary btn-block mt-3">
